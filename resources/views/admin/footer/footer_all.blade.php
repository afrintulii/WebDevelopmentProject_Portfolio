 ...
 <div class="col-12">
   <div class="card">
     <div class="card-body">
      ...
      <form method="POST" action="{{ route('update.footer', ['id' => $allfooter->id]) }}">
  ...
  <div class="row mb-3">
   ...
   <div class="col-sm-10">
  <input  name="instragram" class="form-control" type="text" value="{{$allfooter->instragram}}" id="example-text-input">
  </div>
  </div>
  <!-- end row -->
  <div class="row mb-3">
